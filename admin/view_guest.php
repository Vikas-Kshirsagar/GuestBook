...
error_reporting(0);
 ...
 {
   $rows = mysql_query("SELECT * FROM guests where users_id='".$_GET['id']."' AND name like '%".$_POST['search_text']."%' ORDER BY name LIMIT $start_from, 5");
    $numrows = mysql_num_rows(mysql_query("SELECT * FROM guests where users_id='".$_GET['id']."' AND name like '%".$_POST['search_text']."%'"));
 }
 else
 {
   $rows = mysql_query("SELECT * FROM guests where users_id='".$_GET['id']."' ORDER BY name LIMIT $start_from, 5");
   $numrows = mysql_num_rows(mysql_query("SELECT * FROM guests where users_id='".$_GET['id']."'"));
 }
