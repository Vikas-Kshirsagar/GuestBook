    ...
    <div id="wrapper" class="wat-cf">
      <div id="main">
              ...
              <form action="" method="post" enctype="multipart/form-data" class="form">
                <div class="group">
                  <label class="label">Name</label>
                    ...
                    <span><?php echo isset($_POST['name'])?$_POST['name']:''; ?></span>
                ...
                <div class="group">
                  ...
                  <span><?php echo isset($_POST['email'])?$_POST['email']:''; ?></span>

                </div>
                <div class="group">
                  <label class="label">Address</label>
                  <span><?php echo isset($_POST['address'])?$_POST['address']:''; ?></span>
		...
		<div class="group">
                  ...
                  <span><?php echo isset($_POST['phone'])?$_POST['phone']:''; ?></span>
		...
		<div class="group">
                  <div class="fieldWithErrors">
                    ...
                    <span><?php if($_POST['gender']=='M'){echo "Male";}if($_POST['gender']=='F'){echo "Female";} ?></span>
                </div>
		<div class="group">
                  <div class="fieldWithErrors">
		...
		<div class="group">
                  <div class="fieldWithErrors">
                   ...
                   <span><?php echo isset($_POST['hobbies'])?$_POST['hobbies']:''; ?></span>
                </div>
