<?php
  ...
  {
	  $result = $User->select($User->table,'',"email='{$_POST['email']}' AND password='{$_POST['password']}'");
    ...
    <div id="box">
      ...
      <div class="block" id="block-login">
		...
		<span class="text_button_padding">or</span>
                  <a class="text_button_padding link_button" href="signup.php">Create an account</a>
